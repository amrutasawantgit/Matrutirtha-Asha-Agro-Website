...
const WhoWeServe = () => {
  return (
    <div>
      ...
      <h1 className="text-[28px] font-bold text-center text-gray-700 sm:mx-28 mx-10">
        We have something in store for all
      </h1>
      <h1 className="sm:mx-28 mx-10 mt-6 text-2xl font-semibold">
        Farmars and FPOs
      </h1>
...
.."
      ...
      <h1 className="sm:mx-28 mx-10 mt-6 text-2xl font-semibold">Processors</h1>
      <div className="grid sm:grid-cols-4 grid-cols-1 gap-4 sm:mx-28 mx-10 mt-6">
        <Card
          image="https://storage.googleapis.com/a2z-web/arya/whoweserve/img_6436cbc3d5688.webp"
          title="E-Auctions"
...
.."
      ...
      <h1 className="sm:mx-28 mx-10 mt-6 text-2xl font-semibold">Corporate</h1>
      <div className="grid sm:grid-cols-4 grid-cols-1 gap-4 sm:mx-28 mx-10 mt-6">
        <Card
          image="https://storage.googleapis.com/a2z-web/arya/whoweserve/img_6436cbc3d5688.webp"
          title="E-Auctions"
...
.."
      ...
      <h1 className="sm:mx-28 mx-10 mt-6 text-2xl font-semibold">Traders</h1>
      <div className="grid sm:grid-cols-4 grid-cols-1 gap-4 sm:mx-28 mx-10 mt-6">
        <Card
          image="https://storage.googleapis.com/a2z-web/arya/whoweserve/img_6436cbc3d5688.webp"
          title="E-Auctions"
